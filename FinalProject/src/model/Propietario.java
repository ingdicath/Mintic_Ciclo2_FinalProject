...
/**
 * Class model, contains 'Propietario' attributes, constructor, getters and
 * setters.
 *
 * @author diani
 */
public class Propietario {
    ...
    public Propietario(int propId, String propUsuario, String propApellido, String propNombre, String propTelefono) {
        this.propId = propId;
