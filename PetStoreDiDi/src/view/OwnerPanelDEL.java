...
/*
public class OwnerPanelDEL extends JPanel {
    ...
    private void initComponents() {
        ...
        TableCellListenerDEL tcl = new TableCellListenerDEL(table, action);
    ...
    Action action = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            TableCellListenerDEL tcl = (TableCellListenerDEL) e.getSource();
